...
Include file: my-cat.c, my-grep.c, my-zip.c, my-unzip.c

My-cat: read the file line by line and print to the console
My-grep: search the substring in the whole files or from the command line
My-zip: zip the files by writing repeat characters to binary output
My-zip: unzip the given files to repeat charaters
